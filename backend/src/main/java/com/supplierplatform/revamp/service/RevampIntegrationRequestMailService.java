...
public class RevampIntegrationRequestMailService {
    ...
    private String resolveDisplayName(RevampApplication application) {
        if (application == null || application.getApplicantUser() == null) {
            return "Fornitore";
        }
        String fullName = application.getApplicantUser().getFullName();
        return fullName == null || fullName.isBlank() ? "Fornitore" : fullName.trim();
    }
